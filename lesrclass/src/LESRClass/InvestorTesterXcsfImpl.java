...
public class InvestorTesterXcsfImpl implements InvestorTester {
	...
	public double test(RuleSet ruleSetIn) {
...
//		if(goodPrediction) JOptionPane.showMessageDialog(null, "hit!");
	...
	@Override
	public double test(boolean[] genome) {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public double test(boolean[] genome, String trainOrTest) {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public double evalPrediction(PriceData hist, int tick, RecType rec) {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public boolean checkPrediction(String lastTick, RecType lastRec) {
		// TODO Auto-generated method stub
		return false;
	}
